        ...
        <div>
            <Card className="group relative py-0 gap-0">
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-48">
                    <DropdownMenuItem asChild>
                        <Link href={`/admin/course/${data.id}/edit`} className="flex justify-start items-center">
                        <Pencil className="size-4 mr-2" />
                        Edit Course
                        </Link>
                    </DropdownMenuItem>
                    ...
                    <DropdownMenuItem asChild>
                        <Link href={`/admin/course/${data.slug}`} className="flex justify-start items-center">
                        <Eye className="size-4 mr-2" />
                        Preview
                        </Link>
                    </DropdownMenuItem>
                    ...
                    <DropdownMenuItem asChild>
                        <Link href={`/admin/course/${data.id}/delete`} className="flex justify-start items-center">
                        <Trash className="size-4 mr-2 text-destructive" />
                        Delete Course
                        </Link>
                    </DropdownMenuItem>
                ...
                <CardContent className="p-4">
                    ...
                    <Link className="bg-primary text-white w-full " href={`/admin/course/${data.id}/edit`}>
                       <Button className="w-full text-white mt-4">
