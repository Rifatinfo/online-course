...
import { AlignLeft, Bold, Heading1Icon, Heading2Icon, Heading3Icon, Heading4Icon, Italic, ListIcon, ListOrdered, Redo, Strikethrough, Undo } from "lucide-react";
...
const Menubar = ({ editor }: iAppProps) => {
    ...
    return (
        <div className="border border-input border-x-0 border-t-0 rounded-t-lg p-2 bg-card flex flex-wap gap-1 items-center">
            <TooltipProvider>
                   ...
                   <Tooltip>
                        <TooltipTrigger asChild>
                            <Toggle
                                ...
                                className={cn(
                                    editor.isActive("heading", { level: 4 }) && "bg-muted text-muted-foreground"
                                )}
                            >
                                <Heading4Icon />
                            </Toggle>
                ...
                <div className="flex flex-wrap gap-1">
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Toggle size="sm" pressed={editor.isActive({ textAlign: 'left' })} onPressedChange={() => {
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Toggle size="sm" pressed={editor.isActive({ textAlign: 'right' })} onPressedChange={() => {
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Toggle size="sm" pressed={editor.isActive({ textAlign: 'center' })} onPressedChange={() => {
